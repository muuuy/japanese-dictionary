  ...
  return (
    <section className="flex flex-row flex-1 border-t-2 border-black flex-1 h-2/5">
      ...
      <div className="flex flex-row flex-1 justify-evenly bg-white">
        <div className="flex flex-col w-1/3 justify-center items-center text-center p-2">
        ...
        <div className="flex flex-col w-1/3 justify-center items-center text-center p-2">
          <h3 className="text-3xl font-black">FLASHCARDS</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
        ...
        <div className="flex flex-col w-1/3 justify-center items-center text-center p-2">
          <h3 className="text-3xl font-black">QUIZ</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
